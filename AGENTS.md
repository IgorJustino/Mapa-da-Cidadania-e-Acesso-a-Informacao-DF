...
- Antes de modificacoes relevantes no projeto, consulte `docs/PRD.md`.
...
- Mudancas na Silver devem preservar ou atualizar conscientemente o contrato da Secao 8 do `docs/PRD.md`.
